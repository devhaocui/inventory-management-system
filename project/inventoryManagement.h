...
public:
  // global variables to keep track of file locations
    ...
    // these paths are for deployment
  std::string itemFilePath = "../Resources/data/item.csv";
  std::string userFilePath = "../Resources/data/user.csv";
  const char* font = "../Resources/data/jetbrains.ttf";

  //std::string itemFilePath = "../data/item.csv";
  //std::string userFilePath = "../data/user.csv";
  //const char* font = "../data/jetbrains.ttf";
  std::string userName;
  std::string userPass;
